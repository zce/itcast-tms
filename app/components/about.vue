  ...
  <section id="about" class="modal" v-if="open" transition="toggle">
    <section class="modal-dialog" role="document">
      ...
      <section class="modal-footer">
        <button type="button" class="btn btn-default btn-sm" @click="revealLog()">Find Log File</button>
...
<script>
  export default {
    ...
    methods: {
      ...
      revealLog (item, e) {
        this.$electron.shell.showItemInFolder(this.$config.log4js[0].filename)
      }
    }
  }
</script>
